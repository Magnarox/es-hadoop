...
import org.apache.commons.httpclient.fix.ChunkedOutputStream;
...
import org.apache.commons.httpclient.fix.HttpConstants;
import org.apache.commons.httpclient.fix.HttpState;
import org.apache.commons.httpclient.fix.HttpVersion;
import org.apache.commons.httpclient.fix.ProtocolException;
...
public abstract class EntityEnclosingMethod extends ExpectContinueMethod {
     ...
     * {@link HttpConstants#DEFAULT_CONTENT_CHARSET default}
