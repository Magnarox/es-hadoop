...
import org.apache.commons.httpclient.fix.util.URIUtil;
...
public class HttpURL extends URI {
    ...
    public HttpURL(String userinfo, String host, int port, String path,
        ...
        if (userinfo != null || host != null || port != -1) {
            ...
            if (host != null) {
                buff.append(URIUtil.encode(host, allowed_host));
        ...
        if (path != null) {  // accept empty path
            ...
            buff.append(URIUtil.encode(path, allowed_abs_path));
        }
        if (query != null) {
            buff.append('?');
            buff.append(URIUtil.encode(query, allowed_query));
        }
        if (fragment != null) {
            buff.append('#');
            buff.append(URIUtil.encode(fragment, allowed_fragment));
        }
    ...
    protected static String toUserinfo(String user, String password) throws URIException {
        ...
        usrinfo.append(URIUtil.encode(user, allowed_within_userinfo));
        if (password == null) return usrinfo.toString();
        usrinfo.append(':');
        usrinfo.append(URIUtil.encode(password, allowed_within_userinfo));
