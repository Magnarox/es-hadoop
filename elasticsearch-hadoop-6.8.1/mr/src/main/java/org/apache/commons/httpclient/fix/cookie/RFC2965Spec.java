...
package org.apache.commons.httpclient.fix.cookie;
...
import org.apache.commons.httpclient.fix.Cookie;
import org.apache.commons.httpclient.fix.Header;
import org.apache.commons.httpclient.fix.HeaderElement;
import org.apache.commons.httpclient.fix.NameValuePair;
import org.apache.commons.httpclient.fix.util.ParameterFormatter;
...
public class RFC2965Spec extends CookieSpecBase implements CookieVersionSupport {
    ...
    */
    ...
    /**
     * @see #parse(String, int, String, boolean, Header)
     */
    ...
    /**
     * Performs RFC 2965 compliant {@link Cookie} validation
     *
  ...
  private class Cookie2MaxageAttributeHandler
      ...
      /**
       * @see CookieAttributeHandler#match(Cookie, String)
       */
      public boolean match(final Cookie cookie, final CookieOrigin origin) {
          return true;
      }
